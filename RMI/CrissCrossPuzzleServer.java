 ...
 */
    ...
    /**
 * Name: guessWord
 * Purpose: Displays the current game status for the user identified by userId.
 * Input: userId the ID of the user for whom the game status is to be displayed
 * Output: a string representing the current game status
 * RemoteException if an error occurs during remote method invocation
 */
